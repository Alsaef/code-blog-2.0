...
const Message = () => {
 ...
 <div>
   ...
   {
    isPopup&&  <div className="fixed top-[510px] right-7">
  <div className="flex items-start gap-3 bg-white shadow-lg border border-gray-200 rounded-2xl p-4 w-80">
    ...
    <div>
      <p className="text-gray-700 text-sm leading-relaxed">
        Hello there! 👋 <br /> What is your name?
      </p>
      ...
      <button className='btn mt-4'>Chat</button>
    </div>
  </div>
</div>
        ...
        <div className="fixed top-[700px] right-11">



  <button onClick={()=>setPopup(!isPopup)}
    className="bg-slate-900 text-white hover:bg-slate-800 active:scale-95 transition-all duration-200 
